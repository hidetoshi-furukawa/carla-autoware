...
class LidarSensor(object):
    def __init__(self, parent_actor):
        ...
        bp.set_attribute('channels', '32') #originally 64, reduced to lower workload
        bp.set_attribute('points_per_second', '100000') #originally 250000, reduced to lower workload
        bp.set_attribute('upper_fov', '2.0')
        bp.set_attribute('lower_fov', '-26.8')
        bp.set_attribute('rotation_frequency', '10')
        self.sensor = world.spawn_actor(bp, carla.Transform(carla.Location(x=0, z=2.4)), attach_to=self._parent)
